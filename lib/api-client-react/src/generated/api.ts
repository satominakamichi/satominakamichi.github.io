 ...
 */
export const getGetSatomiStatusUrl = () => {
  return `/api/satomi/status`;
};

export const getSatomiStatus = async (
  options?: RequestInit,
): Promise<SatomiStatus> => {
  return customFetch<SatomiStatus>(getGetSatomiStatusUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetSatomiStatusQueryKey = () => {
  return [`/api/satomi/status`] as const;
};

export const getGetSatomiStatusQueryOptions = <
  TData = Awaited<ReturnType<typeof getSatomiStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSatomiStatus>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSatomiStatusQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSatomiStatus>>> = ({
    signal,
  }) => getSatomiStatus({ signal, ...requestOptions });
...
export type GetSatomiStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSatomiStatus>>
>;
export type GetSatomiStatusQueryError = ErrorType<unknown>;

/**
 * @summary Get Satomi connection status
 */

export function useGetSatomiStatus<
  TData = Awaited<ReturnType<typeof getSatomiStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetSatomiStatusQueryOptions(options);
 ...
 */
export const getGetSatomiStatsUrl = () => {
  return `/api/satomi/stats`;
};

export const getSatomiStats = async (
  options?: RequestInit,
): Promise<SatomiStats> => {
  return customFetch<SatomiStats>(getGetSatomiStatsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetSatomiStatsQueryKey = () => {
  return [`/api/satomi/stats`] as const;
};

export const getGetSatomiStatsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSatomiStats>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSatomiStats>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSatomiStatsQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSatomiStats>>> = ({
    signal,
  }) => getSatomiStats({ signal, ...requestOptions });
...
export type GetSatomiStatsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSatomiStats>>
>;
export type GetSatomiStatsQueryError = ErrorType<unknown>;

/**
 * @summary Get Satomi message statistics
 */

export function useGetSatomiStats<
  TData = Awaited<ReturnType<typeof getSatomiStats>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetSatomiStatsQueryOptions(options);
 ...
 */
export const getGetSatomiLogsUrl = () => {
  return `/api/satomi/logs`;
};

export const getSatomiLogs = async (
  options?: RequestInit,
): Promise<SatomiLogEntry[]> => {
  return customFetch<SatomiLogEntry[]>(getGetSatomiLogsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetSatomiLogsQueryKey = () => {
  return [`/api/satomi/logs`] as const;
};

export const getGetSatomiLogsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSatomiLogs>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSatomiLogs>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSatomiLogsQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSatomiLogs>>> = ({
    signal,
  }) => getSatomiLogs({ signal, ...requestOptions });
...
export type GetSatomiLogsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSatomiLogs>>
>;
export type GetSatomiLogsQueryError = ErrorType<unknown>;

/**
 * @summary Get last 20 Satomi AI response logs
 */

export function useGetSatomiLogs<
  TData = Awaited<ReturnType<typeof getSatomiLogs>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetSatomiLogsQueryOptions(options);
 ...
 */
export const getTestSatomiUrl = () => {
  return `/api/satomi/test`;
};

export const testSatomi = async (
  satomiTestBody: SatomiTestBody,
  options?: RequestInit,
): Promise<SatomiTestResponse> => {
  return customFetch<SatomiTestResponse>(getTestSatomiUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(satomiTestBody),
  });
};

export const getTestSatomiMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof testSatomi>>,
    TError,
    { data: BodyType<SatomiTestBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return testSatomi(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type TestSatomiMutationResult = NonNullable<
  Awaited<ReturnType<typeof testSatomi>>
>;
export type TestSatomiMutationBody = BodyType<SatomiTestBody>;
export type TestSatomiMutationError = ErrorType<unknown>;

/**
 * @summary Manually trigger a test Satomi response
 */
export const useTestSatomi = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getTestSatomiMutationOptions(options));
};

/**
 * @summary Update Satomi configuration (token address)
 */
export const getUpdateSatomiConfigUrl = () => {
  return `/api/satomi/config`;
};

export const updateSatomiConfig = async (
  satomiConfigBody: SatomiConfigBody,
  options?: RequestInit,
): Promise<SatomiStatus> => {
  return customFetch<SatomiStatus>(getUpdateSatomiConfigUrl(), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(satomiConfigBody),
  });
};

export const getUpdateSatomiConfigMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateSatomiConfig>>,
    TError,
    { data: BodyType<SatomiConfigBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["updateSatomiConfig"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateSatomiConfig(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateSatomiConfigMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateSatomiConfig>>
>;
export type UpdateSatomiConfigMutationBody = BodyType<SatomiConfigBody>;
export type UpdateSatomiConfigMutationError = ErrorType<unknown>;

/**
 * @summary Update Satomi configuration (token address)
 */
export const useUpdateSatomiConfig = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getUpdateSatomiConfigMutationOptions(options));
};
